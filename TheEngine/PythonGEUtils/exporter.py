...
def ExportGameWindows(fileLocation):
    ...
    targetDir = os.listdir("C:\\Users\\user\\Desktop\\My Programs\\Python\\PythonGameEngine\\PythonGEUtils\\TheEngine\\PythonGEUtils\\dist")[0]
    ...
    os.rename(thisDir+"\\dist\\"+targetDir,exportLocation+"GameExport")
...
ExportGameWindows("C:\\Users\\user\\Desktop\\GameTest1\\GameTest1.py")
